...
*       Include suggestion for monitoring hyperbolic encounters (suppressed).
     ...
     &          SEMI, ECC2, BODY(ICOMP), BODY(JCOMP),
     &          KSTAR(ICOMP), KSTAR(JCOMP)
   56     FORMAT (F12.3,2I10,1P,5E10.2,2I4)
          CALL FLUSH(31)
      END IF
*
...
*       Check optional output for new KS.
      IF (KZ(10).GT.0.OR.(MAX(KSTAR(ICOMP),KSTAR(JCOMP)).GE.13)) THEN
  ...
  60      FORMAT (/,' NEW KSREG   TIME[NB]',1P,E17.10,' NM1,2,S=',
     ...
     &      ' e,a,eb[NB]=',E16.7,E12.4,E10.2,' P[d]=',E10.2,' H',E10.2,
...
*       Print diagnostics if NS/BH binary not listed among four last pairs.
   ...
   65         FORMAT (' NS/BH BINARY    T ',1P,E10.2,' NM1,2,S',3I10,
     ...
     &               ' R12[NB]',E10.2,' e,p,eb=',E16.7,2E13.5,
