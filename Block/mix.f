...
*       massive (when similarly evolved).
      IF(KSTAR(J1).GE.KSTAR(J2))THEN
          I1 = J1
          I2 = J2
          IF(BODY(J1).LT.BODY(J2))THEN
             I1 = J2
             I2 = J1
          ENDIF
      ELSE
...
*         M02 = M02 - DM
      END IF
      IF (fmrg.GT.0.0D0.AND.MAX(K1,K2).LT.10) THEN
         DM = fmrg*M2
         M3 = M3 - DM
         M03 = M3
         M02 = M02 - DM
         WRITE(6,*) 'Enforced mass loss (MIX): DM = ', DM
      END IF
*
...
*       Accumulate collision diagnostics on unit #13 (filename COLL).
   ...
   35 FORMAT (1X,F11.2,2I8,3I6,4F9.2,2F12.3,F9.1,F10.2,F12.7,1P,E12.1)
          CALL FLUSH(13)
      END IF
*
