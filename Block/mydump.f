...
*
      ...
      INCLUDE 'params.h'
      PARAMETER  (NA=84,NB=168,NC=532,ND=392+MLR+MLD+MLV,NE=24,NM=40,
     &    NG=84+2*KMAX,NL=99,NO=20*MCL+16,NP=32*NTMAX,NQ=31*MMAX,
     &    NS=44*MMAX,NJS1=5,NJS2=4,NJS3=1,NBS3=3,NBS4=3,NBS5=2,
     &    NBS6=6,NBS7=2)
...
*
      ...
      COMMON/RCHE/   Q(NQ)
      COMMON/BINARY/ S(NS)
      COMMON/FLAGS/  JS1(NJS1)
      COMMON/FLAGS2/ JS2(NJS2)
      COMMON/FLAGS3/ JS3(NJS3)
      COMMON/VALUE1/ BS3(NBS3)
      COMMON/VALUE2/ BS4(NBS4)
      COMMON/VALUE4/ BS5(NBS5)
      COMMON/VALUE5/ BS6(NBS6)
      COMMON/VALUE7/ BS7(NBS7)
...
*       Read or save all COMMON variables (valid for tape or disc).
     ...
     &            js1,js2,js3,bs3,bs4,bs5,bs6,bs7
...
*       Check expanding arrays to include possible tidal tails (up to NTTOT).
     ...
     *   (kblist(i),i=1,npairs),(kslow(i),i=1,npairs),(name(i),i=1,ntot)
        ...
        write (J) (SPN(I),I=1,ntot), (ASPN(I),I=1,ntot)
...
*       Restore standard array pointer.
     ...
     *   (kblist(i),i=1,npairs),(kslow(i),i=1,npairs),(name(i),i=1,ntot)
        ...
        read (J) (SPN(I),I=1,ntot), (ASPN(I),I=1,ntot)
        NTOT = NTSAVE
      END IF
*
      RETURN
