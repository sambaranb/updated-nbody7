...
***********************************************
     ...
     &" KS FBFAC FBTOT TIME MHE MCO VKICK KMECH: ",
     &BODY(I)*ZMBAR, BODY0(I)*ZMBAR, KW, I, NAME(I), KSTAR(I),
     &FBFAC, FBTOT, TTOT*TSTAR, MHE, MCO, VKICK, KMECH
         ENDIF
...
*
      if(KW.GE.13)
     &  write(6,*) 'KICK.F [check 1] VK DM ', VKICK, DM
*
...
*
      if(KW.GE.13)
     &  write(6,*) 'KICK.F [check 2] I NAM K* M0 M VI VK VF ',
     &     I, NAME(I), KSTAR(I), BODY0(I)*ZMBAR, ZM,
