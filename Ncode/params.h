...
*     PARAMETER  (NMAX=2000010,KMAX=1000005,LMAX=650,MMAX=500,
      PARAMETER  (NMAX=350010,KMAX=175005,LMAX=650,MMAX=500,
*     PARAMETER  (NMAX=300010,KMAX=150005,LMAX=500,MMAX=500,
*     PARAMETER  (NMAX=110010,KMAX=1010,LMAX=500,MMAX=10,
*     PARAMETER  (NMAX=100010,KMAX=50005,LMAX=500,MMAX=10,
*     PARAMETER  (NMAX=100010,KMAX=1010,LMAX=500,MMAX=10,
*     PARAMETER  (NMAX=100010,KMAX=1010,LMAX=500,MMAX=10,
