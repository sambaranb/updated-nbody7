...
********
      ...
      INTEGER psflag, kmech, ecflag, bhflag, edflag
      REAL*8 neta, bwind, hewind, ALPHA1, LAMBDA, ftzacc
      REAL*8 disp, mxns, beta, psii, acc2, epsnov, eddfac, gamm1
      REAL*8 wconst,fmrg
********
*
     ...
     &               RZ,TINY,SMAX,WTOT,WTOT0,VRMS,RPLM,DUMMY(97)
...
*     For 'comenv.f', 'mix.f', 'coal.f'
      COMMON /VALUE2/ ALPHA1,LAMBDA,ftzacc
*     For 'kick.f', 'hrdiag.f', 'mix.f'
      COMMON /VALUE4/ disp,mxns
*     For 'roche.f', 'mdot.f' (stand alone BSE:'evolv2.f')
      COMMON /VALUE5/ beta,psii,acc2,epsnov,eddfac,gamm1
*     For 'mix.f', 'coal.f', 'mlwind.f'
